...
<link rel="stylesheet" href="<?php echo WEB_ROOT;?>public/admin/css/iframe.css">
...
<script src="<?php echo WEB_ROOT;?>public/admin/js/jquery-ui.js"></script>
<script src="<?php echo WEB_ROOT;?>public/admin/js/jquery.layout.js"></script>
...
{ 
	...
	<?php if (ismobile()) { ?>myLayout.toggle("west");<?php }?>  
});
var zNodes=[<?php echo $str;?>]
...
<div class="ui-layout-center"><iframe name="content_body" id="content_body" src="<?php echo U('lists');?>" width="100%" height="100%" frameborder="0"></iframe></div>
</body>
</html>