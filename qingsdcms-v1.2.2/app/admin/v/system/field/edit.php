            ...
            <div class="ui-tabs-content">
                ...
                <form class="ui-form" method="post">
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                            <input type="text" name="t0" class="ui-form-ip" value="{$ctitle}" placeholder="请输入字段名称" data-rule="字段名称:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">字段Key：</label>
                        <div class="col-right">
                            <input type="text" name="t1" class="ui-form-ip" value="{$ckey}" disabled placeholder="字母和数字的组合，长度3-50个字符" data-rule="字段Key:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                    ...
                    <div class="ui-form-group ui-row dis" id="list">
                        ...
                        <div class="col-right">
                            <textarea name="t3" rows="5" class="ui-form-ip">{$dvalue}</textarea>
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                            <input type="text" name="t4" class="ui-form-ip" value="{$dtext}">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                    ...
                    <div class="ui-form-group ui-row dis" id="showway">
                        ...
                        <div class="col-right col-right-top">
                            <label class="ui-radio"><input type="radio" name="t6" id="t6_1" value="1" {if $rtype==1} checked{/if}><i></i>横排</label>
                            <label class="ui-radio"><input type="radio" name="t6" id="t6_2" value="2" {if $rtype==2} checked{/if}><i></i>竖排</label>
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">状态：</label>
                        <div class="col-right col-right-top">
                            <label class="ui-radio"><input type="radio" name="t7" id="t7_1" value="1" {if $isshow==1} checked{/if}><i></i>正常</label>
                            <label class="ui-radio"><input type="radio" name="t7" id="t7_2" value="0" {if $isshow==0} checked{/if}><i></i>锁定</label>
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
