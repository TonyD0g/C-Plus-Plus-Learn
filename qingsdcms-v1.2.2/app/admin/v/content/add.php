...
<div class="position">当前位置：内容管理 > <a href="{U('lists')}">内容列表</a> > <a href="{THIS_LOCAL}">添加内容</a></div>
<div class="borders">
    <!---->
    ...
    <div class="ui-tabs ui-tabs-white">
        ...
        <div class="ui-tabs-content">
            <div class="ui-tabs-pane active">
				...
				<div class="ui-form-group ui-row group_pic{if $isgroup==0} ui-hide{/if}">
            ...
            <div class="ui-tabs-pane">
                ...
                <div class="ui-form-group ui-row">
                    ...
                    <div class="col-right">
                        <div class="ui-input-group">
                            ...
                            <a class="after fm-choose ui-icon-select" data-name="url" data-url="{U('upload/imagelist','type=3&multiple=0&iseditor=1')}" data-type="1" data-multiple="0" title="选择">选择</a>
                        </div>
                ...
                <div class="ui-form-group ui-row">
                    ...
                    <div class="col-right">
                        <input type="text" name="createdate" class="ui-form-ip datepick-time" value="{date('Y-m-d H:i:s')}" >
                    </div>
                </div>
                <div class="ui-form-group ui-row">
