    ...
    <div class="border_iframe">
        ...
        <form class="ui-form" method="post">
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <input type="text" name="t0" class="ui-form-ip" placeholder="请输入关键字" data-rule="关键字:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">链接网址：</label>
                <div class="ui-col-9">
                    <input type="text" name="t1" class="ui-form-ip" placeholder="请输入链接网址" data-rule="链接网址:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">替换次数：</label>
                <div class="ui-col-9">
                    <input type="text" name="t2" class="ui-form-ip" maxlength="10" value="0">
            ...
            <div class="ui-form-group ui-row ui-mb-0">
                ...
                <div class="ui-col-9 col-right-top">
                    <label class="ui-radio"><input type="radio" name="t4" id="t4_1" value="1" checked><i></i>启用</label>
                    <label class="ui-radio"><input type="radio" name="t4" id="t4_2" value="0"><i></i>锁定</label>
                </div>
            </div>
