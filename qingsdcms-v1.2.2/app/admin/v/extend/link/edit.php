    ...
    <div class="border_iframe">
        ...
        <form class="ui-form" method="post">
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <input type="text" name="t0" class="ui-form-ip" value="{$name}" placeholder="请输入网站名称" data-rule="网站名称:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">网址：</label>
                <div class="ui-col-9">
                    <input type="text" name="t1" class="ui-form-ip" value="{$url}" placeholder="请输入网址" data-rule="网址:required;">
            ...
            <div class="ui-form-group ui-row ui-mb-0">
                ...
                <div class="ui-col-9 col-right-top">
                	<label class="ui-radio"><input type="radio" name="t3" value="1" {if $isshow==1} checked{/if}><i></i>启用</label>
                    <label class="ui-radio"><input type="radio" name="t3" value="0" {if $isshow==0} checked{/if}><i></i>锁定</label>
                </div>
            </div>
