...
<body class="bg-login">
    ...
    <div class="ui-login ui-am-slide-bottom">
        <div class="header">
        	<div class="logo"><a href="{WEB_ROOT}"><span class="ui-icon-home"></span>返回首页</a><img src="{cms[admin_logo]}" height="40"></div>
        </div>
        <form class="ui-form" method="post">
            ...
            <div class="ui-form-group">
                <div class="ui-input-group">
                    ...
                    <span class="code"><img src="{U('code')}" id="verify" data-title="点击更换验证码" class="ui-tips"></span>
                </div>
            </div>
            {/if}
            <div class="ui-form-group">
