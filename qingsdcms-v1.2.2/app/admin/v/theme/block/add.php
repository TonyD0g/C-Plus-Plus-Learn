...
<body>
    <div class="position">当前位置：模板插件 > <a href="{U('index')}">区块管理</a> > <a href="{THIS_LOCAL}">添加区块</a></div>
    <div class="borders">
        <!---->
        <div class="ui-tabs ui-tabs-white" data-href="1">
            <ul class="ui-tabs-nav">
              <li class="active"><a href="{THIS_LOCAL}">添加区块</a></li>
            </ul>
            <div class="ui-tabs-content">
                ...
                <form class="ui-form" method="post">
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                            <input type="text" name="t0" class="ui-form-ip" placeholder="请输入区块说明" data-rule="区块说明:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">关键字：</label>
                        <div class="col-right">
                            <input type="text" name="t1" class="ui-form-ip" placeholder="字母和数字的组合，长度3-50个字符"  data-rule="关键字:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
